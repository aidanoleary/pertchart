...
public class Start extends JFrame{
    ...
    public Start() {
        ...
        while(input.getFinished() == false) {
            ...
            taskList.addTask(new Task (input.getName(), input.getTaskNum(), input.getNumOfDays(),
                        "testStartDate", "testEndDate", scene, parentTask, xPosition, yPosition));
        }
        /*
        while(input.getFinished() == false) {
            input.inputTask();
        ...
        */
        ...
        if(taskList.lengthOfTaskList() > 3) {
            double newSize = 1500 + taskList.lengthOfTaskList() * 200;
